...
ASSIGNMENTS     = {}
DREDD_QUIZ_URL  = 'https://dredd.h4x0r.space/quiz/cse-30872-fa18/'
DREDD_QUIZ_MAX  = 2.0
DREDD_CODE_URL  = 'https://dredd.h4x0r.space/code/cse-30872-fa18/'
DREDD_CODE_MAX  = 6.0
...
def submit_code(assignment, path):
    ...
    for source in sources:
        print('Submitting {} {} ...'.format(assignment, os.path.basename(source)))
